#!/bin/bash
# analyse pacbio data (align raw reads to mycoplasma genomes)
...
mkdir /stornext/Projects/promethion/promethion_access/lab_ritchie/transcr_bench_PacBio/long_term/H201SC20030389/raw_aligned_mycoplasma
OUT_DIR="/stornext/Projects/promethion/promethion_access/lab_ritchie/transcr_bench_PacBio/long_term/H201SC20030389/raw_aligned_mycoplasma"
...
${REFERENCE} \
${BAM} \
${OUT_DIR}/${OUT_P}_aligned_to_mycoplasma.bam \
